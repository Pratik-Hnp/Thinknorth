            ...
            <div className="grid md:grid-cols-2 gap-12 items-center">
              ...
              <div>
                ...
                <p className="text-gray-600 leading-relaxed mb-6">
                  Established in 2009 to provide complete Financial Intelligence, <strong>Think North</strong> is a Full-service Chartered Accountancy firm offering specialized advisory and accounting services. With a team of highly qualified professionals bringing years, diligence, and dedication, we help clients navigate the more, financial, complex, and financial decisions.
                </p>
              </div>
            </div>
          </div>
